...
void main()
{
    ...
    else   /// conseguiu abrir os dois arquivos
    {
        ...
        /// faz a alteração de um arquivo, na verdade, apaga o arquivo
        /// de origem e troca o nome do arquivo de destino para
        /// o nome original
        remove(nomeorigem); /// apaga o arquivo com nome nomeorigem
        rename(nomedestino, nomeorigem); /// troca o nome do arquivo
    }
}
